...
export default function Pedometro() {
    const [currentStepCout, setCurrentStepCount] = useState(0)
    ...
    const _subscribe = () => {
        ...
        Pedometer.isAvailableAsync().then(
            ...
            error => {
                setIsPedometerAvailable('Could net get isPedometerAvailable: ' + error);
            }
        );
    ...
    return (
        <View style={styles.container}>
            ...
            <Text>Walk! And watch this go up: {currentStepCout}</Text>
        </View>
    );
}